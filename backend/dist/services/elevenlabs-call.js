 ...
 */
export async function initiateClinicCall(phoneNumber, reason, clinicName, patientInfo) {
 ...
 */
function containsSchedulingInfo(text) {
 ...
 */
function handleSchedulingOffer(text) {
    if (!activeCall)
        return;
    ...
    const slots = parseTimeSlotsFromText(text);
 ...
 */
export async function sendResponseToCall(response) {
 ...
 */
function parseTimeSlotFromString(s) {
